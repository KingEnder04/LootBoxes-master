...
import lootboxes.LBContent.LootTables.LootBoxTierThreeLootTable;
...
public class LootBoxTierThree extends MultiTextureMatItem {
    public LootBoxTierThree() {
    ...
    public ListGameTooltips getTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard) {
        ...
        tooltips.add(Localization.translate("itemtooltip", "lootboxlbtip"));
    ...
    public Supplier<ContainerActionResult> getInventoryRightClickAction(Container container, InventoryItem item, int slotIndex, ContainerSlot slot) {
        return () -> {
            if (container.getClient().isServer()) {
                ...
                LootBoxTierThreeLootTable.lootBox.addItems(itemList, GameRandom.globalRandom, 1.0F, new Object[]{container.getClient()});
