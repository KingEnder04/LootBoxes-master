...
import lootboxes.LBContent.LootTables.RandomFoodBagLootTable;
...
public class RandomFoodBag extends MultiTextureMatItem {
    public RandomFoodBag() {
    ...
    public ListGameTooltips getTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard) {
        ...
        tooltips.add(Localization.translate("itemtooltip", "foodbaglbtip"));
    ...
    public Supplier<ContainerActionResult> getInventoryRightClickAction(Container container, InventoryItem item, int slotIndex, ContainerSlot slot) {
        return () -> {
            if (container.getClient().isServer()) {
                ...
                RandomFoodBagLootTable.foodBag.addItems(itemList, GameRandom.globalRandom, 1.0F, new Object[]{container.getClient()});
