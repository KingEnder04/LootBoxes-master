...
public class LootBoxTierFiveLootTable extends LootTable {
    public static final OneOfLootItems chestloottierfive = new OneOfLootItems(new LootItem("dawnhelmet"),
            new LootItemInterface[]{new LootItem("dawnchestplate"), new LootItem("dawnboots"),
    ...
    public static final OneOfLootItems matstierfive = new OneOfLootItems(LootItem.between("slimeessence", 5, 10), new LootItemInterface[]{LootItem.between("bloodessence", 5, 10), LootItem.between("primordialessence", 5, 10), LootItem.between("bioessence", 5, 10), LootItem.between("shadowessence", 5, 10), LootItem.between("cryoessence", 5, 10), LootItem.between("spideressence", 5, 10), LootItem.between("upgradeshard", 20, 50), LootItem.between("alchemyshard", 20, 50)});
    public static final OneOfLootItems potions = new OneOfLootItems(LootItem.between("greaterattackspeedpotion", 4, 8), new LootItemInterface[]{LootItem.between("greaterhealthpotion", 8, 16), LootItem.between("greatermanapotion", 8, 16), LootItem.between("greaterhealthregenpotion", 4, 8), LootItem.between("speedpotion", 4, 8), LootItem.between("battlepotion", 4, 8), LootItem.between("resistancepotion", 4, 8), LootItem.between("thornspotion", 4, 8), LootItem.between("minionpotion", 4, 8)});
