...
public class LootBoxTierOneLootTable extends LootTable {
    public static final OneOfLootItems chestloottierone = new OneOfLootItems(new LootItemInterface[]{new LootItem("fuzzydice"),
            new LootItem("heavyhammer"),
    ...
    public static final OneOfLootItems orestierone = new OneOfLootItems(new LootItemInterface[]{LootItem.offset("copperore", 12, 2), LootItem.offset("ironore", 12, 2), LootItem.offset("goldore", 12, 2), LootItem.offset("frostshard", 6, 2)});
